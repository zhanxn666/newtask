...
from MFFN.MFFN_COD_main.utils.io.genaral import get_datasets_info_with_keys
from MFFN.MFFN_COD_main.utils.io.image import read_color_array, read_gray_array
...
class MFFN_COD_TrainDataset(_BaseSODDataset):
    ...
    #__getitem__ is a required method in any PyTorch Dataset class
    def __getitem__(self, index):  
        image_path = self.total_image_paths[index]
        mask_path = self.total_mask_paths[index]
        image = read_color_array(image_path)
...
import MFFN.MFFN_COD_main.utils.builder as builder

builder.DATASETS.register(name="MFFN_cod_te")(MFFN_COD_TestDataset)
builder.DATASETS.register(name="MFFN_cod_tr")(MFFN_COD_TrainDataset)