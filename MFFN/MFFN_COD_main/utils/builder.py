...
from MFFN.MFFN_COD_main.utils.registry import Registry

DATASETS = Registry(name="dataset")
DATASETS.import_module_from_module_names(["MFFN.MFFN_COD_main.dataset"], verbose=False)
MODELS = Registry(name="model")
MODELS.import_module_from_module_names(["MFFN.MFFN_COD_main.methods"], verbose=False)
